...
public class TesterModel extends ThreePlayerImpl {
  ...
  Move getWinInTwo(LocationState player1, LocationState player2) {
    ...
    for(Move move : getPossibleMoves(player1)) {
      ...
      //try the move
      //System.out.println("before" + getGameState());
      move(move.x,move.y,move.z,move.dir,move.player);
      //System.out.println("after" + getGameState());
      ...
      if(getWinningMove(player2) == null) {
        ...
        ArrayList<Move> possibilities = getPossibleMoves(player2);
        //System.out.println("After move " + move.x + " " + move.y + " " + move.z + " " + move.dir);
        printarray(possibilities);
        for (Move secondMove : possibilities) {
